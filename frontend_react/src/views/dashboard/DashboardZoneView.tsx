            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 mb-10">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            className="bg-purple-600 text-white hover:bg-purple-700 font-bold px-6 py-3 text-lg cursor-pointer transition-all rounded-xl shadow-sm hover:shadow-md flex items-center gap-2"
                        ...
                        <button
                            className={`font-bold px-6 py-3 text-lg transition-all rounded-xl shadow-sm flex items-center gap-2 ${
                                aiDashCode
