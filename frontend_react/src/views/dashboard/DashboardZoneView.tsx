            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 mb-10">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            className="bg-indigo-600 text-white hover:bg-indigo-700 font-bold px-6 py-3 text-lg cursor-pointer transition-all rounded-xl shadow-sm hover:shadow-md flex items-center gap-2"
                            onClick={() => navigate(`/projects/${projectIdFromParams}/view-ai-dashboard`)}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
