                                    ...
                                    <Menu as="div" className="relative flex-none">
                                        ...
                                        >
                                            <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                                <Menu.Item>
                                                    <Link to={`/board/${data._id}`} className="block px-3 py-1 text-sm leading-6 text-gray-900">
                                                        Ver Proyecto
                                                    </Link>
                                                </Menu.Item>
                                                <Menu.Item>
                                                    <Link to={`/board/${data._id}/edit`} className="block px-3 py-1 text-sm leading-6 text-gray-900">
                                                        Editar Proyecto
                                                    </Link>
                                                </Menu.Item>
                                                <Menu.Item>
